...
---
format: revealjs
output-dir: docs   # <-- output folder
---

## Filipino Population Hotspots 
...
filipino_pop_df <- read_excel("copy_econstats_compressed.xlsx") 
...
Figure 3. An interactive map showcasing the percentages of Filipino populations of high schools in the Southern California area. 
